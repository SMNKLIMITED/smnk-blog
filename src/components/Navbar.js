      ...
      <div className="container px-5 md:px-16 flex items-center justify-between mx-auto">
        <Link href={"/"}>
          <h2 className="text-3xl">
            <span className="text-blue-600">S</span>MNK BLOG
          </h2>
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-4 md:gap-2 lg:gap-4">
          <button className="capitalize text-sm sm:text-base border-2 hover:border-2 font-semibold sm:py-3 py-2 px-3 sm:px-6 text-black-600 border-blue-600 hover:border-white-600 hover:bg-blue-600 hover:text-white rounded-full">
