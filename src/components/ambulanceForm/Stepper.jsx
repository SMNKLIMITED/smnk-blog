    ...
    return (
        ...
        className={
         ...
         "w-full flex items-center" : "flex items-center" }>
          ...
          ${step.selected ? "bg-blue-500 text-white font-bold border border-blue" : ""}`}>
          {/* display number */}
          {step.completed ? (
          ...
          <div className={`absolute top-0 text-center mt-16 w-32 text-[8px]  lg:text-2xs font-thin lg:font-semibold lg:font-mono capitalize sm:uppercase
